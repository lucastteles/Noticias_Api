...
using Noticias.Application.Application;
using Noticias.Application.Interface;
using Noticias.Domain.Repositories;
using Noticias.Repo;
using Noticias.Repo.Repositories;
using System;
...
namespace Noticias.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Noticias.API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Noticias.API v1"));
            }
